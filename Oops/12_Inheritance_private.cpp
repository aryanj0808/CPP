...
{ // Here visibility is private so we can not access class base data directly in main fuction using class derived
public:
	int num3;
	int operation();
	int display();
...
int derived ::display()
{
	cout << "Num 1 =" << getnum1() << endl; // Here we call function for accessing private data member
	cout << "Num 2 =" << num2 << endl;		// Direct access for public data member
